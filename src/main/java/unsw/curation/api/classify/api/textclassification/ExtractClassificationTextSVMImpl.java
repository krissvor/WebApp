...
import unsw.curation.api.classify.api.domain.abstraction.IClassificationTextSVM;
...
public class ExtractClassificationTextSVMImpl implements IClassificationTextSVM {
	...
	@Override
	public List<Classification> EvaluateSVM() throws Exception
	{
