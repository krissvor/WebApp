package unsw.curation.api.classify.api.extractstem;

import unsw.curation.api.classify.api.domain.ExtractStem;
import unsw.curation.api.classify.api.domain.abstraction.IStem;
